...
private:
    ...
    static constexpr double maximum_velocity = 20 * steps_per_rev;		// in [milli-step/ms]
    static constexpr double maximum_acceleration = 32;		//32;//16 * 200 * 100 / 40 / 100;	// in [milli-step/ms^2]
